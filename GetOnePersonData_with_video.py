...
for video in os.listdir('process_basketball_Video/shoot'):

    vs=cv2.VideoCapture('process_basketball_Video/shoot/'+video)
    ...
    np.save('Original_data/shoot/'+video.replace(".mp4",".npy"),KeypointFrame)
